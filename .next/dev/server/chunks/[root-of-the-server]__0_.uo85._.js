...
async function updateSession(request) {
    ...
    if (user && pathname.startsWith('/admin')) {
        ...
        if (profile?.role !== 'admin') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/member/dashboard', request.url));
        }
    }
...
async function proxy(request) {
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$proxy$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["updateSession"])(request);
}
const config = {
    matcher: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0_.uo85._.js.map